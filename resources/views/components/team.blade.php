    ...
    <div class="mx-auto py-12 px-4 max-w-screen-xl sm:px-6 lg:px-8 lg:py-24">
        <div class="grid grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-8">
            <div class="space-y-5 sm:space-y-4">
                <h2 class="text-3xl leading-9 font-extrabold tracking-tight sm:text-4xl">Meet our leadership</h2>
                <p class="text-xl leading-7 text-gray-500">Libero fames augue nisl porttitor nisi, quis. Id ac elit odio
                    vitae elementum enim vitae ullamcorper suspendisse. Vivamus fringilla.</p>
            </div>
